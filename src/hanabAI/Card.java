...
public class Card{
	...
	private boolean colourRevealed = false;
...
//	public String toString(){return colour.toString()+"-"+value;}
	...
	{
//		System.err.println("Player "+s.getNextPlayer()+" sees card: isOwner="+(s.getPlayers()[s.getNextPlayer()]==owner)+" C="+colourRevealed+" V="+valueRevealed);
		StringBuffer sb = new StringBuffer();
		if (s.getNextPlayer()>-1 && s.getPlayers()[s.getNextPlayer()]==owner && !colourRevealed)
			sb.append("  ");
		else
			sb.append(colour);
		sb.append("-");
		if (s.getNextPlayer()>-1 && s.getPlayers()[s.getNextPlayer()]==owner && !valueRevealed)
			sb.append("  ");
		else
			sb.append(value);
		sb.append(" ");
